...
public class MXM {
    ...
    //***************************Digital output******************************
    private ReadCoilsRequest readReqDO = null;  //memory bit mx (read) request
    private ReadCoilsResponse readResDO = null; //memory bit mx (read) response
   ...
   // private WriteMultipleRegistersResponse writeResMultipleRegister = null;   //registers (write) request
    ...
    public MXM(InetAddress ip, int port, int id) {
        this.ip = ip;
        this.port = port;
        repeat = 0;
        this.id=id;
    ...
    public boolean ping(){
        ...
        try {
            ...
            //Logger.getLogger(MXM.class.getName()).log(Level.SEVERE, null, ex);
        }
        this.port = temp;
        return p;
    }
